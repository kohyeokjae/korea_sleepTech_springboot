...
public class K_Controller_Mapping {
    /*
        === Spring controller 매핑에서 사용하는 주요 어노테이션 정리 ===
        ...
        3. @PathVariable
           : URL 경로 자체에 포함된 변수를 매핑하여 받는 어노테이션
        ...
        4. @AuthenticationPrincipal
           : 로그인한 사용자 정보를 컨트롤러 메서드 파라미터로 직접 가져오는 어노테이션
           - Spring Security가 인증된 사용자를 SecurityContext에 저장하고
             , 해당 어노테이션이 인증 사용자 정보를 꺼내옴
