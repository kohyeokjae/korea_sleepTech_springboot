...
public class E_IoC_DI {
    ...
    class BookStore2 {
        ...
        @Autowired // 스프링 컨테이너에서 해당 타입의 빈을 찯아 주입하는 어노테이션
    ...
    // : 클래스가 필요로 하는 객체(의존성, Dependency)를 의부에서 "주입(Injection)"해주는 방식
    // - 제어의 역전을 구현하기 위한 방법
