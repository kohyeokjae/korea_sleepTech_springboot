...
public class J_JpaRepository {
    // JpaRepository<E, ID>
    // : Spring Data JPA에서 게공하는 기본 인터페이스
    ...
    // findByCategoryAndPrice(String category, int minPrice, int maxPrice)

    // cf) @Query 조건 복잡하거나 JOIN이 필요한 경우 메서드 이름만으로 한계가 있음, 직접 쿼리 작성 가능
}
