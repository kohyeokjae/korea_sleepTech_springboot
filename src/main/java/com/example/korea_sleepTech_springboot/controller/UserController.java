...
public class UserController {
    ...
    public ResponseEntity<ResponseDto<GetUserResponseDto>> getUserInfo(
        ...
        // : 현재 인증된(로그인된) 사용자의 정보를 가져오는 어노테이션
        @AuthenticationPrincipal String userEmail
    ) {
        ResponseDto<GetUserResponseDto> responseDto = userService.getUserInfo(userEmail);
    ...
    public ResponseEntity<ResponseDto<GetUserResponseDto>> updateUserInfo(
        ...
        ResponseDto<GetUserResponseDto> responseDto = userService.updateUserInfo(userEmail, dto);
        return ResponseEntity.ok(responseDto);
    }
    ...
    public ResponseEntity<ResponseDto<Void>> deleteUser(
        ...
        ResponseDto<Void> responseDto = userService.deleteUser(userEmail);
