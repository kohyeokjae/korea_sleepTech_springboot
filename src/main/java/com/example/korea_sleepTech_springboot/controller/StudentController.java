...
@RestController // @Controller + @ResponseBody 결합된 어노테이션: RESTful 웹 서비스의 컨트롤러임을 명시
...
public class StudentController {
    ...
    /*
        ...
        @Return: StudentDto
     */
    // "/studnet/{id}" 경로로 오는 GET 요청을 처리 - {id}는 경로 변수로 사용
    @GetMapping("/{id}")
    ...
    /*
        @Params: id (특정 학생의 id), StudentDto (수정할 학생 정보)
        @Return: StudentDto
     */
    @PutMapping("/{id}")
