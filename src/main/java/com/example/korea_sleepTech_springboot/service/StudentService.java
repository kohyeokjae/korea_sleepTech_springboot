...
import com.example.korea_sleepTech_springboot.repository.StudnetRepository;
...
public class StudentService {
    ...
    public StudentService(StudnetRepository studnetRepository) {
    ...
    public List<StudentResponseDto> getAllStudents() {
        ...
        try {
            List<B_Student> students = studnetRepository.findAll();
    ...
    public StudentResponseDto getStudentById(Long id) {
        ...
        try {
            B_Student student = studnetRepository.findById(id)
    ...
    public StudentResponseDto createStudent(StudentCreateRequestDto studentDto) {
        ...
        try {
            ...
            B_Student savedStudent = studnetRepository.save(student);

            // 저장되고 난 후 B_Student 객를 DTO로 변환하여 반환
            studentResponseDto = new StudentResponseDto(
                    savedStudent.getId(),
    ...
    public StudentResponseDto updateStudent(Long id, StudentUpdateRequestDto studentDto) {
        ...
        try {
            ...
            B_Student updatedStudent = studnetRepository.save(student);
    ...
    public void deleteStudent(Long id) {
        try {
            ...
            studnetRepository.delete(student); // 조회한 학색 객체를 DB에서 삭제
