...
import com.example.korea_sleepTech_springboot.dto.order.OrderItemRequesetDto;
...
public class OrderServiceImpl implements OrderService {
    ...
    public ResponseDto<OrderResponseDto> placeOrder(String userEmail, OrderRequestDto requestDto) {
        ...
        User user = userRepository.findByEmail(userEmail)
            .orElseThrow(() -> new IllegalArgumentException("해당 Eamil의 사용자가 없습니다."));
        ...
        for (OrderItemRequesetDto dto : requestDto.getItems()) {
