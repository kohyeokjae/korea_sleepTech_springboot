...
public class RegexDto {
    ...
    // phoneNumber: 핸드폰 번호 양식이 올바르지 않습니다.
    // nickname: 닉네임은 2 ~ 10자 영문 / 숫자 / 한긂만 사용 가능합니다.
    // gender, birthDate, region 등등

    @NotBlank
    @Email(message = "유요한 이메일 주소여야 합니다.") // 일반 정규표현식 사용 권장
